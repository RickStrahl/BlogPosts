...
Markdown Monster 4.5 is a major update to Markdown Monster. This releases replaces  the main editor rendering surface with Microsoft's [Monaco Editor](https://microsoft.github.io/monaco-editor/) from the original [ACE Editor](https://ace.c9.io/) implementation since MM's very beginnings.
